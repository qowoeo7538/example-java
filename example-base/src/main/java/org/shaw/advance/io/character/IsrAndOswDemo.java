package org.shaw.advance.io.character;
...
public class IsrAndOswDemo {
    ...
    public static void inputStreamReaderDemo(String srcData,String copyData)throws Exception {
        FileInputStream fileInputStream = new FileInputStream(new File(srcData));
        InputStreamReader inputStreamReader = new InputStreamReader(fileInputStream); //默认项目的编码,操作的时候，要写文件本身的编码格式
