...
public class FrAndFwDemo {
     ...
     * @throws Exception
     */
    public static void copyText(String srcData,String copyData) throws Exception {
        FileReader fileReader = new FileReader(srcData);
        ...
        while ((i=fileReader.read(c,0,c.length))!=-1){
            ...
            fileWriter.write(c,0,i);  //使用i，读到多少字符就写多少字符
            fileWriter.flush();
        }
        fileReader.close();
        fileWriter.close();
