...
public class PathDemo {
    ...
    private static void loadSource() {
        // 从classpath下加载资源
        PathDemo.class.getResource("/org/shaw/base/path/PathDemo.class");
        // 从当前目录下加载资源
        PathDemo.class.getResource("PathDemo.class");
        // 从classpath下加载资源
        PathDemo.class.getClassLoader().getResource("org/shaw/base/path/PathDemo.class");
    }
}
