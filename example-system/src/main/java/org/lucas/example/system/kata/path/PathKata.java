package org.lucas.example.system.kata.path;
...
public class PathKata {
    ...
    public void loadSource() {
        // 从classpath下加载资源
        System.out.println(PathKata.class.getResource("/org/lucas/example/system/kata/path/PathDemo.class"));
        // 从当前目录下加载资源
        System.out.println(PathKata.class.getResource("PathDemo.class"));
        // 从classpath下加载资源
        System.out.println(PathKata.class.getClassLoader().getResource("org/lucas/example/system/kata/path/PathDemo.class"));
    }
}
