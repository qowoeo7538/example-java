package org.lucas.example.foundation.jvm.load;

import org.junit.jupiter.api.Test;
import org.lucas.example.foundation.jvm.load.impl.MyClassLoader;
...
public class ClassLoaderDemo {
    ...
    public void defaultClassLoader() throws Exception {
        ...
        Object obj1 = ClassLoaderDemo.class.getClassLoader().loadClass("org.lucas.example.foundation.jvm.load.impl.MyClassLoader").getConstructor().newInstance();
