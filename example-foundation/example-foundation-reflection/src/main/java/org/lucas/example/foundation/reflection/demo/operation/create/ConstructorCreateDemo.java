package org.lucas.example.foundation.reflection.demo.operation.create;

import org.lucas.example.foundation.reflection.demo.operation.create.impl.ConstructorReflectClass;
...
public class ConstructorCreateDemo {
    public static void main(String[] args) throws Exception {
        Class constructorReflectClass = Class.forName("org.lucas.example.foundation.reflection.demo.operation.create.impl.ConstructorReflectClass");
