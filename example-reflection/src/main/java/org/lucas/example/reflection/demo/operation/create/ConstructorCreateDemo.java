package org.lucas.example.reflection.demo.operation.create;

import org.lucas.example.reflection.demo.operation.create.impl.ConstructorReflectClass;
...
public class ConstructorCreateDemo {
    public static void main(String[] args) throws Exception {
        Class constructorReflectClass = Class.forName("org.lucas.example.reflection.demo.operation.create.impl.ConstructorReflectClass");
