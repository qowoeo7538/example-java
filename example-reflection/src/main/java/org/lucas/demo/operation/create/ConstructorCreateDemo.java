package org.lucas.demo.operation.create;

import org.lucas.demo.operation.create.impl.ConstructorReflectClass;
...
public class ConstructorCreateDemo {
    public static void main(String[] args) throws Exception {
        Class constructorReflectClass = Class.forName("org.lucas.demo.operation.create.impl.ConstructorReflectClass");
