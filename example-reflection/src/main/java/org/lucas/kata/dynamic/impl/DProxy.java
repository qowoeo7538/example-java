package org.lucas.kata.dynamic.impl;
...
public class DProxy {
    ...
    public static Object createProxy(Class<?> targetClass, Interceptor interceptor) {
        ...
        try {
            /*获得DProxy类作为代理类的父类*/
            CtClass superclass = pool.get("com.myweb.reflect.proxy.DProxy");
            ...
            /*创建构造方法以便注入拦截器*/
            CtConstructor cc = new CtConstructor(new CtClass[]{pool.get("com.myweb.reflect.proxy.Interceptor")}, proxy);
            cc.setBody("{super($1);}");
