package org.lucas.example.framework.disruptor.demo;
...
import org.lucas.example.framework.disruptor.demo.consumer.ApplicationConsumer;
import org.lucas.example.framework.disruptor.demo.consumer.JournalConsumer;
import org.lucas.example.framework.disruptor.demo.consumer.ReplicationConsumer;
import org.lucas.example.framework.disruptor.demo.event.LongEvent;
import org.lucas.example.framework.disruptor.demo.event.LongEventFactory;
import org.lucas.example.framework.disruptor.demo.producer.LongEventProducer;
...
public class LongEventDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 便遵循 Single Writer 原则，减少 CAS 操作，最后设置 RingBuffer 的等待策略为 LiteTimeoutBlockingWaitStrategy、BlockingWaitStrategy。
        Disruptor<LongEvent> disruptor = new Disruptor<>(factory, bufferSize, DaemonThreadFactory.INSTANCE, ProducerType.SINGLE, new LiteTimeoutBlockingWaitStrategy(1000, TimeUnit.MILLISECONDS));
