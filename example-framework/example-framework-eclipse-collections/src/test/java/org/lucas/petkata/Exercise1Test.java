...
public class Exercise1Test extends PetDomainForKata {
    ...
    public void getFirstNamesOfAllPeople() {
        ...
        MutableList<String> firstNames = people.collect(Person::getFirstName); // this.people...
    ...
    public void getPeopleWithCats() {
        ...
        MutableList<Person> peopleWithCats = people.select(person -> person.hasPet(PetType.CAT));  // this.people...
    ...
    public void getPeopleWithoutCats() {
        ...
        MutableList<Person> peopleWithoutCats = people.reject(person -> person.hasPet(PetType.CAT));  // this.people...
