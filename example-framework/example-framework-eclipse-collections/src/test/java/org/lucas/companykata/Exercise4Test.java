...
public class Exercise4Test extends CompanyDomainForKata {
    ...
    public void countSuppliersWithMoreThanTwoItems() {
        Predicate<Supplier> moreThanTwoItems = (Supplier supplier) -> supplier.getItemNames().size() > 2;
    ...
    public void whoSuppliesSandwichToaster() {
        ...
        Predicate<Supplier> suppliesToaster = supplier ->
                Iterate.contains(supplier.getItemNames(), "sandwich toaster");
    ...
    public void filterOrderValues() {
        ...
        MutableList<Double> orderValues = new FastList<>(orders).asLazy()
    ...
    public void filterOrderValuesUsingPrimitives() {
        List<Order> orders = this.company.getMostRecentCustomer().getOrders();
        MutableDoubleList orderValues = new FastList<>(orders).asLazy()
    ...
    public void filterOrders() {
        List<Order> orders = this.company.getMostRecentCustomer().getOrders();
        MutableList<Order> filtered = new FastList<>(orders).select(order -> order.getValue() > 2.0);
