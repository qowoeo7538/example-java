...
public class Exercise2Test extends CompanyDomainForKata {
    ...
    public void doAnyCustomersLiveInLondon() {
        boolean anyCustomersFromLondon = this.company.getCustomers()
                .anySatisfy(customer -> "London".equals(customer.getCity()));
        Assert.assertTrue(anyCustomersFromLondon);
    }

    @Test
    public void doAllCustomersLiveInLondon() {
        boolean allCustomersFromLondon = this.company.getCustomers()
                .allSatisfy(customer -> "London".equals(customer.getCity()));
    ...
    public void howManyCustomersLiveInLondon() {
        int numberOfCustomerFromLondon = this.company.getCustomers()
                .count(customer -> "London".equals(customer.getCity()));
    ...
    public void getCustomersWhoDontLiveInLondon() {
        MutableList<Customer> customersNotFromLondon = this.company.getCustomers()
                .reject(customer -> "London".equals(customer.getCity()));
    ...
    public void getCustomersWhoDoAndDoNotLiveInLondon() {
        PartitionMutableList<Customer> customers = this.company.getCustomers()
                .partition(customer -> "London".equals(customer.getCity()));
