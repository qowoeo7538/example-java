...
public class Exercise7Test extends CompanyDomainForKata {
    ...
    public void customersByCity() {
        MutableListMultimap<String, Customer> multimap = this.company.getCustomers()
                .groupBy(Customer::getCity);
    ...
    public void itemsBySuppliers() {
        MutableMultimap<String, Supplier> itemsToSuppliers = ArrayIterate
                .collect(this.company.getSuppliers(), supplier -> supplier)
                .groupByEach(supplier -> supplier.getItemNames());
