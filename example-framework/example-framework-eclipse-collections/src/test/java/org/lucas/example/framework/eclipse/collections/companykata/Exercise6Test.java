...
public class Exercise6Test extends CompanyDomainForKata {
    ...
    public void sortedTotalOrderValueUsingPrimitives() {
        MutableDoubleList sortedTotalValues = this.company.getCustomers()
    ...
    public void customerWithMaxTotalOrderValue() {
        Customer customerWithMaxTotalOrderValue = this.company.getCustomers()
    ...
    public void supplierNamesAsTildeDelimitedString() {
        String tildeSeparatedNames = FastList.newListWith(this.company.getSuppliers())
    ...
    public void deliverOrdersToLondon() {
        this.company.getCustomers().asLazy()
