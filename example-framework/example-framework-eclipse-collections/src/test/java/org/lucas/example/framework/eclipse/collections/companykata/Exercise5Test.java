...
public class Exercise5Test extends CompanyDomainForKata {
    ...
    public void filterOrderValues() {
        ...
        MutableList<Double> orderValues = new FastList<>(orders).collect(Order::getValue);
        ...
        Verify.assertInstanceOf(MutableList.class, filtered);
    ...
    public void filterOrderValuesUsingPrimitives() {
        List<Order> orders = this.company.getMostRecentCustomer().getOrders();
        MutableDoubleList orderValues = new FastList<>(orders).collectDouble(Order::getValue);
