...
public class PropertiesDemo {
     ...
     * @throws Exception
     */
    public static void propertiesOutTest(OutputStream fileOutputStream, Properties properties, String annotation, String encode)
            throws IOException {
        try (BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(fileOutputStream, encode))) {
